 ...
 */
function PinboardClient(apiToken, responseFormat) {
  if (!(this instanceof PinboardClient)) {
    return new PinboardClient(apiToken, responseFormat);
  }
...
PinboardClient.prototype.getApiCallUrl = function (method) {
  ...
  parts.query = { auth_token: this.apiToken, format: this.format };
