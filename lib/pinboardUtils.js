   ...
   function updateRedisPinboardPosts(callback) {
    pinboard.getAllPosts(function (error, response, body) {
      ...
      if (!error && response.statusCode === 200) {
        var err = error || 'Status Code ' + response.statusCode;
      ...
      try {
        ...
        e.message = 'Error parsing Pinboard data: ' + e.message;
        console.log(e.message);
        console.log('Pinboard response body: ' + body);
      ...
      console.info('Pinboard data saved to redis');
